	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="http://localhost:8080/api/customers/createCustomer" method="post" enctype="application/x-www-form-urlencoded">
          ...
          <input type="text" name="securityCode" value="<?php echo $securityCode ?>" hidden>
